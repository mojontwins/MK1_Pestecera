...
..\..\..\src\utils\zx0.exe assets\trpixlut.bin assets\trpixlutc.bin
...
zcc +cpc -a -vn -O3 -unsigned -crt0=crt.asm -zorg=1024 -lcpcrslib_fg -DCPC_GFX_MODE=%cpc_gfx_mode% -o %game%.bin tilemap_conf.asm mk1.c > nul
