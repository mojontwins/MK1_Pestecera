...
.TTEMPO defb 0 ;defb CONTADOR TEMPO

.PUNTERO_A defw 0 ;defw PUNTERO DEL CANAL A
.PUNTERO_B defw 0 ;defw PUNTERO DEL CANAL B
.PUNTERO_C defw 0 ;defw PUNTERO DEL CANAL C

.CANAL_A defw 0 ;defw DIRECION DE INICIO DE LA MUSICA A
.CANAL_B defw 0 ;defw DIRECION DE INICIO DE LA MUSICA B
.CANAL_C defw 0 ;defw DIRECION DE INICIO DE LA MUSICA C

.PUNTERO_P_A defw 0 ;defw PUNTERO PAUTA CANAL A
.PUNTERO_P_B defw 0 ;defw PUNTERO PAUTA CANAL B
.PUNTERO_P_C defw 0 ;defw PUNTERO PAUTA CANAL C

.PUNTERO_P_A0 defw 0 ;defw INI PUNTERO PAUTA CANAL A
.PUNTERO_P_B0 defw 0 ;defw INI PUNTERO PAUTA CANAL B
.PUNTERO_P_C0 defw 0 ;defw INI PUNTERO PAUTA CANAL C

.PUNTERO_P_DECA defw 0 ;defw PUNTERO DE INICIO DEL DECODER CANAL A
.PUNTERO_P_DECB defw 0 ;defw PUNTERO DE INICIO DEL DECODER CANAL B
.PUNTERO_P_DECC defw 0 ;defw PUNTERO DE INICIO DEL DECODER CANAL C

.PUNTERO_DECA defw 0 ;defw PUNTERO DECODER CANAL A
.PUNTERO_DECB defw 0 ;defw PUNTERO DECODER CANAL B
.PUNTERO_DECC defw 0 ;defw PUNTERO DECODER CANAL C 

.REG_NOTA_A defb 0 ;defb REGISTRO DE LA NOTA EN EL CANAL A
.VOL_INST_A defb 0 ;defb VOLUMEN RELATIVO DEL INSTRUMENTO DEL CANAL A
.REG_NOTA_B defb 0 ;defb REGISTRO DE LA NOTA EN EL CANAL B
.VOL_INST_B defb 0 ;defb VOLUMEN RELATIVO DEL INSTRUMENTO DEL CANAL B ;VACIO
.REG_NOTA_C defb 0 ;defb REGISTRO DE LA NOTA EN EL CANAL C
.VOL_INST_C defb 0 ;defb VOLUMEN RELATIVO DEL INSTRUMENTO DEL CANAL C

.PUNTERO_L_DECA defw 0 ;defw PUNTERO DE INICIO DEL LOOP DEL DECODER CANAL A
.PUNTERO_L_DECB defw 0 ;defw PUNTERO DE INICIO DEL LOOP DEL DECODER CANAL B
.PUNTERO_L_DECC defw 0 ;defw PUNTERO DE INICIO DEL LOOP DEL DECODER CANAL C

;CANAL DE EFECTOS DE RITMO - ENMASCARA OTRO CANAL

.PUNTERO_P defw 0 ;defw PUNTERO DEL CANAL EFECTOS
.CANAL_P defw 0 ;defw DIRECION DE INICIO DE LOS EFECTOS
.PUNTERO_P_DECP defw 0 ;defw PUNTERO DE INICIO DEL DECODER CANAL P
.PUNTERO_DECP defw 0 ;defw PUNTERO DECODER CANAL P
.PUNTERO_L_DECP defw 0 ;defw PUNTERO DE INICIO DEL LOOP DEL DECODER CANAL P
;SELECT_CANAL_P defb INTERR+$36 ;defb SELECCION DE CANAL DE EFECTOS DE RITMO


.SFX_L defw 0 ;defw DIRECCION BUFFER EFECTOS DE RITMO REGISTRO BAJO
.SFX_H defw 0 ;defw DIRECCION BUFFER EFECTOS DE RITMO REGISTRO ALTO
.SFX_V defw 0 ;defw DIRECCION BUFFER EFECTOS DE RITMO REGISTRO VOLUMEN
.SFX_MIX defw 0 ;defw DIRECCION BUFFER EFECTOS DE RITMO REGISTRO MIXER
...
;defb [13] BUFFERs DE REGISTROS DEL PSG

.PSG_REG DS 16
.PSG_REG_SEC DS 16
.ENVOLVENTE defb 0 ;defb : FORMA DE LA ENVOLVENTE
