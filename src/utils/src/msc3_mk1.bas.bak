...
Print #f3, "// Generated by Mojon Script Compiler v3.97 20191202 from MT Engine MK1 v5.0+"
Print #f3, "// Copyleft 2014, 2019 The Mojon Twins"
Print #f3, ""
...
Print #f3, "// msc.h"
Print #f3, "// Generated by Mojon Script Compiler v3.97 20191202 from MT Engine MK1 v5.0+"
Print #f3, "// Copyleft 2015 The Mojon Twins"
Print #f3, ""
...
if clausulasUsed (&H12) Then
	...
	print #f3, "                            call _read_two_bytes_d_e"
	print #f3, "                            // Set sc_terminado if flags [C] <= E"
	print #f3, "                            // or...            if E >= flags [C]"
	print #f3, "                            ld  b, 0"
	print #f3, "                            ld  c, d"
	print #f3, "                            ld  hl, _flags"
	print #f3, "                            add hl, bc"
	print #f3, "                            ld  a, e     ; A = E (second byte)"
	print #f3, "                            ld  e, (hl)  ; E = flags [C]"
	print #f3, "                            cp  e"	
	print #f3, "                            jr  c, _flag_equal_greater_ok ; branch if A < E"
	print #f3, "                            ld  a, 1"
	print #f3, "                            ld  (_sc_terminado), a"
...
If actionsUsed (&HE6) Then
	...
	print #f3, "                            _AY_PL_MUS (level_data->music_id);"
	print #f3, "#else"
	print #f3, "                            _AY_PL_MUS (sc_n);"
	print #f3, "#endif"
	print #f3, "                        }"
	print #f3, "                        break;"
End If
