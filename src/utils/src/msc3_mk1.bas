...
if command (1) = "" or  maxidx = 0 then
    print "MojonTwins Scripts Compiler v3.98b 20231124"
    print "MT Engine MK1 PSTCRA v5.10+"
	Print
...
Print #f3, "// Generated by Mojon Script Compiler v3.98b 20231124 from MT Engine MK1 PSTCRA v5.10+"
...
Print #f3, "// msc.h"
Print #f3, "// Generated by Mojon Script Compiler v3.98b 20231124 from MT Engine MK1 PSTCRA v5.10+"
Print #f3, "// Copyleft 2015, 2019, 2022, 2023 The Mojon Twins"
Print #f3, ""
...
if actionsUsed (&HE0) Then
	...
	print #f3, "                        AY_PLAY_SOUND (read_vbyte ());"
	print #f3, "                        break;"
End If
...
if actionsUsed (&HE3) Then
	print #f3, "                    case 0xE3:"
	print #f3, "                        _y = LINE_OF_TEXT; _x = LINE_OF_TEXT_X;"


	print #f3, "                       	#asm"
	print #f3, "                      			xor a "
	print #f3, "                       			ld  (_rdn), a 		; Strlen"
	print #f3, ""
	print #f3, "                       			call __tile_address	; DE = buffer address"
	print #f3, ""
	print #f3, "                       		.msc_print_str_loop"
	print #f3, "                       			call _read_byte     ; A <- new byte"
	print #f3, "                       			cp  0xEE"
	print #f3, "                       			jr  z, msc_print_str_inv "
	print #f3, ""
	print #f3, "                       			ld  (de), a"
	print #f3, "                       			inc de"
	print #f3, ""
	...
	print #f3, "                       			ld  (_rdn), a"
	print #f3, ""
	print #f3, "                       			jr  msc_print_str_loop"
	print #f3, ""
	print #f3, "                       		.msc_print_str_inv"
	print #f3, ""
	print #f3, "                       			; Invalidate cells based upon strlen."
	print #f3, "                       			ld  a, (__y)"
	print #f3, "                       			ld  b, a"
	print #f3, "                       			ld  d, a"
	print #f3, "                       			ld  a, (__x)"
	...
	print #f3, "                       			dec a"
	print #f3, "                       			ld  e, a"
	print #f3, "                       			call cpc_InvalidateRect"
	print #f3, "                       	#endasm"
	print #f3, "                        break;"
End If
...
if actionsUsed (&HE5) Then
	print #f3, "                    case 0xE5:"
	print #f3, "                        // PAUSE sc_n"
	print #f3, "						espera_activa (read_byte ());"
	print #f3, "                        break;"
End If
...
If actionsUsed (&HE6) Then
	...
	print #f3, "                            AY_STOP_SOUND ();"
	print #f3, "                        } else {"
	print #f3, "#ifdef COMPRESSED_LEVELS"
	print #f3, "                            level_data->music_id = sc_n;"
	print #f3, "                            AY_PLAY_MUSIC (level_data->music_id);"
	print #f3, "#else"
	print #f3, "                            AY_PLAY_MUSIC (sc_n);"
	print #f3, "#endif"
	print #f3, "                        }"
	print #f3, "                        break;"
End If
