...
;
;	Module compile time: Sun May 01 23:36:26 2022
	...
	C_LINE	101,"c:\z88dk\Lib\Config\\..\..\/include/cpcrslib.h"
	C_LINE	102,"c:\z88dk\Lib\Config\\..\..\/include/cpcrslib.h"
	C_LINE	7,"mk1.c"
	C_LINE	10,"mk1.c"
		XREF _nametable
		LIB cpc_KeysData
	...
	C_LINE	236,"my/config.h"
	C_LINE	237,"my/config.h"
	._def_keys
		defw $4404 		; LEFT     O
		defw $4308 		; RIGHT    P
		defw $4808 		; UP       Q
...
._mapa
	...
	defb	0
	SECTION	code_compiler
	C_LINE	57,"assets/mapa.h::blackout::0::2"
	C_LINE	61,"assets/mapa.h::blackout::0::2"
...
._malotes
	...
	defb	0
	SECTION	code_compiler
	C_LINE	213,"assets/enems.h::blackout::0::2"
	C_LINE	217,"assets/enems.h::blackout::0::2"
	SECTION	data_compiler
._hotspots
	defb	18
	defb	1
	...
	C_LINE	18,"assets/extrasprites.h::blackout::0::2"
	C_LINE	19,"assets/extrasprites.h::blackout::0::2"
	...
	._sprite_18_a
		defs 96, 0
	C_LINE	37,"assets/extrasprites.h::blackout::0::2"
		._sprite_19_a
...
._sm_coy
	...
	SECTION	data_compiler
._sm_invfunc
	defw	cpc_PutSpTileMap16x24PxM1 + 0
	defw	cpc_PutSpTileMap16x24PxM1 + 0
	defw	cpc_PutSpTileMap16x24PxM1 + 0
	defw	cpc_PutSpTileMap16x24PxM1 + 0
	defw	cpc_PutSpTileMap16x24PxM1 + 0
	...
	SECTION	data_compiler
._sm_updfunc
	defw	cpc_PutTrSp16x24TileMap2bPxM1 + 0
	defw	cpc_PutTrSp16x24TileMap2bPxM1 + 0
	defw	cpc_PutTrSp16x24TileMap2bPxM1 + 0
	defw	cpc_PutTrSp16x24TileMap2bPxM1 + 0
	defw	cpc_PutTrSp16x24TileMap2bPxM1 + 0
	...
	._sm_sprptr
		defw _sprites + 0x0000, _sprites + 0x0060, _sprites + 0x00C0, _sprites + 0x0120
		defw _sprites + 0x0180, _sprites + 0x01E0, _sprites + 0x0240, _sprites + 0x02A0
...
._qtile
	...
	C_LINE	134,"printer.h::qtile::0::4"

; Function _tile_address flags 0x00000200 __smallc 
; void _tile_address()
	C_LINE	134,"printer.h::_tile_address::0::4"
.__tile_address
			ld  a, (__y)
			add a, a	; 2		4
			add a, a	; 4		4
	...
	C_LINE	167,"printer.h::_tile_address::0::5"

; Function draw_coloured_tile flags 0x00000200 __smallc 
; void draw_coloured_tile()
	C_LINE	167,"printer.h::draw_coloured_tile::0::5"
._draw_coloured_tile
	...
	C_LINE	450,"printer.h::draw_coloured_tile::0::6"

; Function invalidate_tile flags 0x00000200 __smallc 
; void invalidate_tile()
	C_LINE	450,"printer.h::invalidate_tile::0::6"
._invalidate_tile
			ld  a, (__x)
			ld  e, a
			ld  a, (__y)
	...
	C_LINE	470,"printer.h::invalidate_tile::0::7"

; Function invalidate_viewport flags 0x00000200 __smallc 
; void invalidate_viewport()
	C_LINE	470,"printer.h::invalidate_viewport::0::7"
...
._draw_invalidate_coloured_tile_gamearea
	...
	C_LINE	487,"printer.h::draw_invalidate_coloured_tile_gamearea::0::9"

; Function draw_coloured_tile_gamearea flags 0x00000200 __smallc 
; void draw_coloured_tile_gamearea()
	C_LINE	487,"printer.h::draw_coloured_tile_gamearea::0::9"
._draw_coloured_tile_gamearea
	...
	C_LINE	491,"printer.h::draw_coloured_tile_gamearea::0::10"

; Function draw_decorations flags 0x00000200 __smallc 
; void draw_decorations()
	C_LINE	491,"printer.h::draw_decorations::0::10"
._draw_decorations
			ld  hl, (__gp_gen)
	...
	C_LINE	535,"printer.h::draw_decorations::0::11"
	SECTION	data_compiler
._utaux
	defb	0
	SECTION	code_compiler
	C_LINE	536,"printer.h::draw_decorations::0::11"

; Function update_tile flags 0x00000200 __smallc 
; void update_tile()
	C_LINE	536,"printer.h::update_tile::0::11"
._update_tile
		ld  a, (__x)
		ld  c, a
		ld  a, (__y)
	...
	C_LINE	578,"printer.h::update_tile::0::12"

; Function print_number2 flags 0x00000200 __smallc 
; void print_number2()
	C_LINE	578,"printer.h::print_number2::0::12"
._print_number2
	ld	hl,(__t)
	ld	h,0
	ld	de,10
	...
	C_LINE	600,"printer.h::print_number2::0::13"

; Function draw_objs flags 0x00000200 __smallc 
; void draw_objs()
	C_LINE	600,"printer.h::draw_objs::0::13"
._draw_objs
	ld	a,30
	ld	(__x),a
	ld	a,12
	...
	C_LINE	663,"printer.h::draw_objs::0::14"

; Function print_str flags 0x00000200 __smallc 
; void print_str()
	C_LINE	663,"printer.h::print_str::0::14"
._print_str
			xor a 
			ld  (_rdn), a 		; Strlen
			call __tile_address	; DE = buffer address
	...
	C_LINE	717,"printer.h::print_str::0::15"

; Function clear_sprites flags 0x00000200 __smallc 
; void clear_sprites()
	C_LINE	717,"printer.h::clear_sprites::0::15"
._clear_sprites
	xor	a
	ld	(_gpit),a
	jp	i_18	;EOS
...
.i_20
	...
	C_LINE	68,"mk1.c::pal_set::0::18"
	C_LINE	0,"engine/update.h::pal_set::0::18"
	C_LINE	9,"engine/update.h::pal_set::0::18"
...
; parameter 'unsigned char sprites' at sp+2 size(1)
	C_LINE	9,"engine/update.h::cpc_UpdateNow::0::18"
._cpc_UpdateNow
	ld	hl,2	;const
	add	hl,sp
	ld	l,(hl)
...
.i_22
	...
	C_LINE	69,"mk1.c::cpc_UpdateNow::0::21"
	C_LINE	0,"my/ci/extra_functions.h::cpc_UpdateNow::0::21"
	C_LINE	70,"mk1.c::cpc_UpdateNow::0::21"
	C_LINE	0,"engine/general.h::cpc_UpdateNow::0::21"
	C_LINE	14,"engine/general.h::cpc_UpdateNow::0::21"

; Function collide flags 0x00000200 __smallc 
; unsigned char collide()
	C_LINE	14,"engine/general.h::collide::0::21"
._collide
			ld  hl, 0
			ld  a, (_cx2)
			ld  c, a 
	...
	C_LINE	63,"engine/general.h::collide::0::22"

; Function cm_two_points flags 0x00000200 __smallc 
; unsigned char cm_two_points()
	C_LINE	63,"engine/general.h::cm_two_points::0::22"
._cm_two_points
			ld  a, (_cx1)
			cp  15
	...
	C_LINE	138,"engine/general.h::cm_two_points::0::23"

; Function rand flags 0x00000200 __smallc 
; unsigned char rand()
	C_LINE	138,"engine/general.h::rand::0::23"
._rand
		.rand16
			ld	hl, _seed
			ld	a, (hl)
	...
	C_LINE	182,"engine/general.h::rand::0::24"

; Function abs flags 0x00000200 __smallc 
; unsigned int abs(int n)
; parameter 'int n' at sp+2 size(2)
	C_LINE	182,"engine/general.h::abs::0::24"
._abs
	pop	bc
	pop	hl
	push	hl
...
.i_24
	...
	C_LINE	79,"mk1.c::abs::0::25"
	C_LINE	0,"engine/breakable.h::abs::0::25"
	C_LINE	6,"engine/breakable.h::abs::0::25"

; Function break_wall flags 0x00000200 __smallc 
; void break_wall()
	C_LINE	6,"engine/breakable.h::break_wall::0::25"
._break_wall
	ld	hl,(__x)
	ld	h,0
	push	hl
	...
	ld	a,l
	ld	(_gpit),a
	C_LINE	0,"./my/ci/on_wall_hit.h::break_wall::2::27"
	C_LINE	15,"engine/breakable.h::break_wall::2::27"
	jp	i_26	;EOS
.i_25
	xor	a
	ld	(__n),a
	...
	ld	a,l
	ld	(_gpit),a
	C_LINE	0,"./my/ci/on_wall_broken.h::break_wall::2::28"
	C_LINE	25,"engine/breakable.h::break_wall::2::28"
.i_26
	ld	de,_brk_buff
	ld	hl,(_gpaux)
	ld	h,0
	...
	C_LINE	81,"mk1.c::break_wall::0::28"
	C_LINE	0,"engine/simple_cocos.h::break_wall::0::28"
	C_LINE	12,"engine/simple_cocos.h::break_wall::0::28"

; Function simple_coco_init flags 0x00000200 __smallc 
; void simple_coco_init()
	C_LINE	12,"engine/simple_cocos.h::simple_coco_init::0::28"
._simple_coco_init
	xor	a
	ld	(_enit),a
	jp	i_29	;EOS
...
.i_28
	...
	C_LINE	16,"engine/simple_cocos.h::simple_coco_init::0::29"

; Function simple_coco_shoot flags 0x00000200 __smallc 
; void simple_coco_shoot()
	C_LINE	16,"engine/simple_cocos.h::simple_coco_shoot::0::29"
._simple_coco_shoot
			ld  de, (_enit)
			ld  d, 0 					 
			ld  hl, _cocos_y
	...
	C_LINE	64,"engine/simple_cocos.h::simple_coco_shoot::0::30"

; Function simple_coco_update flags 0x00000200 __smallc 
; void simple_coco_update()
	C_LINE	64,"engine/simple_cocos.h::simple_coco_update::0::30"
._simple_coco_update
	ld	a,4
	ld	(_enspit),a
	xor	a
...
.i_31
	...
	C_LINE	87,"mk1.c::simple_coco_update::0::34"
	C_LINE	0,"engine.h::simple_coco_update::0::34"
	C_LINE	0,"my/fixed_screens.h::simple_coco_update::0::34"
	C_LINE	4,"my/fixed_screens.h::simple_coco_update::0::34"

; Function game_ending flags 0x00000200 __smallc 
; void game_ending()
	C_LINE	4,"my/fixed_screens.h::game_ending::0::34"
._game_ending
	call	_blackout
	ld	hl,_s_ending
	push	hl
	...
	C_LINE	19,"my/fixed_screens.h::game_ending::0::35"

; Function game_over flags 0x00000200 __smallc 
; void game_over()
	C_LINE	19,"my/fixed_screens.h::game_over::0::35"
._game_over
	ld	a,10
	ld	(__x),a
	ld	a,11
	...
	C_LINE	14,"engine.h::game_over::0::36"
	C_LINE	16,"engine.h::game_over::0::36"
...
; parameter 'int n' at sp+4 size(2)
	C_LINE	16,"engine.h::addsign::0::36"
._addsign
	ld	hl,4	;const
	call	l_gintsp	;
	ld	a,h
...
.i_41
	...
	C_LINE	81,"engine.h::espera_activa::0::39"

; Function process_tile flags 0x00000200 __smallc 
; void process_tile()
	C_LINE	81,"engine.h::process_tile::0::39"
._process_tile
				.push_boxes
					ld  a, (_x0)
					ld  c, a
	...
	ld	hl,3	;const
	call	_wyz_play_sound
	C_LINE	0,"my/ci/on_tile_pushed.h::process_tile::1::40"
	C_LINE	216,"engine.h::process_tile::1::40"
				.push_boxes_end
	ret


	C_LINE	336,"engine.h::process_tile::0::40"

; Function draw_scr_background flags 0x00000200 __smallc 
; void draw_scr_background()
	C_LINE	336,"engine.h::draw_scr_background::0::40"
...
.i_46
	...
	C_LINE	0,"my/ci/map_renderer_t_modification.h::draw_scr_background::3::42"
	C_LINE	455,"engine.h::draw_scr_background::3::42"
						ld  hl, _map_buff
						add hl, bc
						ld  (hl), a
						ld  hl, _brk_buff
...
.i_45
	...
	C_LINE	503,"engine.h::draw_scr_background::0::42"

; Function draw_scr flags 0x00000200 __smallc 
; void draw_scr()
	C_LINE	503,"engine.h::draw_scr::0::42"
._draw_scr
	call	cpc_ResetTouchedTiles
	ld	hl,1	;const
	ld	a,l
	...
	call	_enems_load
	C_LINE	0,"my/ci/entering_screen.h::draw_scr::1::43"
	C_LINE	532,"engine.h::draw_scr::1::43"
			ld  a, 240
			ld  (_hotspot_y), a
			ld  a, (_n_pant)
			ld  b, a
...
.i_48
	...
	C_LINE	827,"engine.h::mons_col_sc_x::0::44"

; Function mons_col_sc_y flags 0x00000200 __smallc 
; unsigned char mons_col_sc_y()
	C_LINE	827,"engine.h::mons_col_sc_y::0::44"
._mons_col_sc_y
...
.i_50
	...
	C_LINE	92,"mk1.c::mons_col_sc_y::0::45"
	C_LINE	0,"engine/player.h::mons_col_sc_y::0::45"
	C_LINE	13,"engine/player.h::mons_col_sc_y::0::45"

; Function player_init flags 0x00000200 __smallc 
; void player_init()
	C_LINE	13,"engine/player.h::player_init::0::45"
._player_init
	ld	a,16
	ld	hl,_gpx
	ld	(hl),a
	...
	C_LINE	67,"engine/player.h::player_init::0::46"

; Function player_calc_bounding_box flags 0x00000200 __smallc 
; void player_calc_bounding_box()
	C_LINE	67,"engine/player.h::player_calc_bounding_box::0::46"
._player_calc_bounding_box
	...
	C_LINE	241,"engine/player.h::player_calc_bounding_box::0::47"

; Function player_move flags 0x00000200 __smallc 
; unsigned char player_move()
	C_LINE	241,"engine/player.h::player_move::0::47"
._player_move
	...
	C_LINE	0,"./my/ci/custom_veng.h::player_move::1::49"
	C_LINE	355,"engine/player.h::player_move::1::49"
	ld	de,(_p_y)
	ld	hl,(_p_vy)
	add	hl,de
	ld	(_p_y),hl
...
.i_53
	...
	jp	z,i_55	;
.i_56
	C_LINE	0,"./my/ci/bg_collision/obstacle_up.h::player_move::3::51"
	C_LINE	393,"engine/player.h::player_move::3::51"
	ld	hl,0	;const
	ld	(_p_vy),hl
					ld  a, (_pty1)
					inc a 
...
.i_60
	defc	i_61 = i_59
.i_65_i_61
	C_LINE	0,"./my/ci/bg_collision/obstacle_down.h::player_move::3::53"
	ld	hl,(_p_vy)
	ld	de,64
	ex	de,hl
	call	l_gt
...
.i_70_i_69
	...
	call	_break_wall
.i_68
	C_LINE	470,"engine/player.h::player_move::3::56"
.i_66
	ld	a,(_p_saltando)
	and	a
	jp	nz,i_71	;
...
.i_91
	...
	ld	(_p_facing),a
.i_94
	C_LINE	0,"./my/ci/custom_heng.h::player_move::1::67"
	C_LINE	699,"engine/player.h::player_move::1::67"
.i_93
	ld	de,(_p_x)
	ld	hl,(_p_vx)
	add	hl,de
...
.i_96
	...
	jp	z,i_98	;
.i_99
	C_LINE	0,"./my/ci/bg_collision/obstacle_left.h::player_move::3::69"
	C_LINE	739,"engine/player.h::player_move::3::69"
	ld	hl,0	;const
	ld	(_p_vx),hl
					ld  a, (_ptx1)
					inc a 
...
.i_97
	...
	jp	z,i_102	;
.i_103
	C_LINE	0,"./my/ci/bg_collision/obstacle_right.h::player_move::3::71"
	C_LINE	814,"engine/player.h::player_move::3::71"
	ld	hl,0	;const
	ld	(_p_vx),hl
					ld  a, (_ptx1)
					sla a 
...
.i_101
	...
	or	l
	jp	z,i_106	;
	C_LINE	0,"./my/ci/on_special_tile.h::player_move::2::73"
	C_LINE	963,"engine/player.h::player_move::2::73"
.i_106
	ld	hl,(_wall_h)
	ld	h,0
	ld	a,l
...
.i_108
	...
	ld	a,l
	ld	(_hit),a
	C_LINE	0,"./my/ci/custom_evil_tile_check.h::player_move::1::75"
	ld	hl,(_p_vy)
	ld	de,0
	ex	de,hl
	call	l_gt
	jp	nc,i_110	;
		...
		.custom_hit_do
			...
			ld  (_p_vy), hl
		.custom_hit_done
	C_LINE	1201,"engine/player.h::player_move::1::76"
.i_110
	ld	a,(_hit)
	and	a
	jp	z,i_111	;
	...
	ld	(_p_killme),a
.i_112
	C_LINE	0,"./my/custom_animation.h::player_move::1::78"
.i_111
	._pca_hit
		ld  a, (_p_killme)
		or  a
	...
	call	l_gint	;
	call	l_pint_pop
	C_LINE	1227,"engine/player.h::player_move::1::78"
		._player_spr_setup
			ld  a, (_gpx)
			add  0  * 8
			add ([ 0xE600  + 6])
			...
			or  a 
			jr  z, _player_spr_setup_done
			ld  ([ 0xE600  + 0]), _sprite_18_a%256
			ld  ([ 0xE600  + 1]), _sprite_18_a/256
		._player_spr_setup_done
	ret


	C_LINE	1334,"engine/player.h::player_move::0::78"

; Function player_deplete flags 0x00000200 __smallc 
; void player_deplete()
	C_LINE	1334,"engine/player.h::player_deplete::0::78"
._player_deplete
	ld	de,(_p_life)
	ld	d,0
	ld	hl,(_p_kill_amt)
...
.i_114
	...
	C_LINE	1338,"engine/player.h::player_deplete::0::79"
...
; parameter 'unsigned char sound' at sp+2 size(1)
	C_LINE	1338,"engine/player.h::player_kill::0::79"
._player_kill
	ld	hl,0	;const
	ld	a,l
	ld	(_p_killme),a
	...
	C_LINE	93,"mk1.c::player_kill::0::80"
	C_LINE	0,"engine/enengine.h::player_kill::0::80"
	C_LINE	6,"engine/enengine.h::player_kill::0::80"
	.calc_baddies_pointer
		...
		add hl, de
		ret
	C_LINE	66,"engine/enengine.h::player_kill::0::80"

; Function enems_init flags 0x00000200 __smallc 
; void enems_init()
	C_LINE	66,"engine/enengine.h::enems_init::0::80"
._enems_init
	xor	a
	ld	(_enit),a
.i_115
...
.i_116
	...
	C_LINE	79,"engine/enengine.h::enems_init::0::82"

; Function enems_load flags 0x00000200 __smallc 
; void enems_load()
	C_LINE	79,"engine/enengine.h::enems_load::0::82"
._enems_load
	ld	hl,(_n_pant)
	ld	h,0
	ld	b,h
...
.i_119
	...
	jp	nc,i_118	;
				...
				add c 
				ld  (_enoffsmasi), a
	C_LINE	0,"./my/ci/enems_custom_respawn.h::enems_load::3::84"
	C_LINE	128,"engine/enengine.h::enems_load::3::84"
...
.i_128
	...
	C_LINE	208,"engine/enengine.h::enems_load::5::86"
.i_129
	ld	de,_en_an_base_frame
	ld	hl,(_enit)
	ld	h,0
...
.i_132
	...
	C_LINE	237,"engine/enengine.h::enems_load::3::89"
	jp	i_117	;EOS
.i_118
	ret


	C_LINE	241,"engine/enengine.h::enems_load::0::89"

; Function enems_kill flags 0x00000200 __smallc 
; void enems_kill()
	C_LINE	241,"engine/enengine.h::enems_kill::0::89"
._enems_kill
			ld  a, (__en_t)
			cp  7
		...
		.enems_kill_noflag
			ld  hl, _p_killed
			inc (hl)
	C_LINE	0,"./my/ci/on_enems_killed.h::enems_kill::1::90"
	C_LINE	264,"engine/enengine.h::enems_kill::1::90"
	ret


	C_LINE	271,"engine/enengine.h::enems_kill::0::90"

; Function enems_move flags 0x00000200 __smallc 
; void enems_move()
	C_LINE	271,"engine/enengine.h::enems_move::0::90"
._enems_move
	ld	hl,0	;const
	ld	(_ptgmy),hl
	ld	(_ptgmx),hl
...
.i_143
	...
	C_LINE	442,"engine/enengine.h::enems_move::4::93"
	ld	hl,(_rdt)
	ld	h,0
	ld	a,l
	cp	5
	jp	nz,i_144	;
	C_LINE	0,"./engine/enem_mods/enem_type_orthoshooters.h::enems_move::5::94"
	call	_rand
	ld	a,l
	and	15
	ld	l,a
	...
	C_LINE	445,"engine/enengine.h::enems_move::5::95"
	jp	i_137	;EOS
	defc	i_145 = i_137
	defc	i_144 = i_137
	C_LINE	0,"./my/ci/enems_move.h::enems_move::4::95"
	C_LINE	460,"engine/enengine.h::enems_move::4::95"
.i_137
	ld	hl,(_active)
	ld	a,l
	and	a
...
.i_160_i_158
	...
	defc	i_148 = i_162
.i_147
	C_LINE	0,"./my/ci/custom_enems_player_collision.h::enems_move::5::104"
	C_LINE	557,"engine/enengine.h::enems_move::5::104"
	ld	a,(__en_x)
	ld	(_cx2),a
	ld	a,(__en_y)
	ld	(_cy2),a
...
.i_166
	...
	pop	bc
	ld	(_p_vy),hl
	C_LINE	0,"./my/ci/on_enems_collision.h::enems_move::7::108"
	C_LINE	614,"engine/enengine.h::enems_move::7::108"
.i_169
.i_163
.i_162
.i_170
	C_LINE	0,"./my/ci/enems_extra_actions.h::enems_move::4::108"
	C_LINE	799,"engine/enengine.h::enems_move::4::108"
.i_146
			._enem_spr_setup
				ld  a, (_enit)
				add  1 
...
.i_134
	...
	C_LINE	94,"mk1.c::enems_move::0::108"
	C_LINE	0,"engine/hotspots.h::enems_move::0::108"
	C_LINE	7,"engine/hotspots.h::enems_move::0::108"

; Function hotspots_init flags 0x00000200 __smallc 
; void hotspots_init()
	C_LINE	7,"engine/hotspots.h::hotspots_init::0::108"
._hotspots_init
				ld  b,  3  *  12 
				ld  hl, _hotspots + 2
				ld  de, 3
	...
	C_LINE	30,"engine/hotspots.h::hotspots_init::0::109"

; Function hotspots_do flags 0x00000200 __smallc 
; void hotspots_do()
	C_LINE	30,"engine/hotspots.h::hotspots_do::0::109"
._hotspots_do
	ld	hl,_hotspots
	push	hl
	ld	hl,(_n_pant)
...
.i_178
	...
	call	_wyz_play_sound
	jp	i_174	;EOS
	C_LINE	0,"./my/ci/hotspots_custom.h::hotspots_do::3::112"
	C_LINE	117,"engine/hotspots.h::hotspots_do::3::112"
.i_174
...
.i_172
	...
	C_LINE	95,"mk1.c::hotspots_do::0::113"
	C_LINE	0,"my/wyz/efectos.h::hotspots_do::0::113"
	C_LINE	4,"my/wyz/efectos.h::hotspots_do::0::113"
	.EFECTO0 
		defb 0x25, 0x1C, 0x00
		defb 0x3A, 0x0F, 0x00
		defb 0x2D, 0x0F, 0x00
	...
	.EFECTO14 
		...
		defb 0x80, 0x0F, 0x00
		defb 0xFF
	C_LINE	102,"mk1.c::hotspots_do::0::113"
	C_LINE	0,"my/wyz/instrumentos.h::hotspots_do::0::113"
	C_LINE	7,"my/wyz/instrumentos.h::hotspots_do::0::113"
	...
	C_LINE	103,"mk1.c::hotspots_do::0::113"
	C_LINE	0,"my/wyz/songs.h::hotspots_do::0::113"
	C_LINE	4,"my/wyz/songs.h::hotspots_do::0::113"
	C_LINE	6,"my/wyz/songs.h::hotspots_do::0::113"
	._00_title_mus_bin
	...
	C_LINE	104,"mk1.c::hotspots_do::0::113"
	C_LINE	0,"wyz_player.h::hotspots_do::0::113"
	C_LINE	8,"wyz_player.h::hotspots_do::0::113"

; Function wyz_init flags 0x00000200 __smallc 
; void wyz_init()
	C_LINE	8,"wyz_player.h::wyz_init::0::113"
._wyz_init
	ld	hl,0	;const
	ld	a,l
	ld	(_isr_player_on),a
	...
	C_LINE	17,"wyz_player.h::wyz_init::0::114"
...
; parameter 'unsigned char m' at sp+2 size(1)
	C_LINE	17,"wyz_player.h::wyz_play_music::0::114"
._wyz_play_music
	push	hl
	ld	hl,_wyz_songs
	push	hl
	...
	C_LINE	29,"wyz_player.h::wyz_play_music::0::115"
...
; parameter 'unsigned char s' at sp+2 size(1)
	C_LINE	29,"wyz_player.h::wyz_play_sound::0::115"
._wyz_play_sound
	push	hl
	...
	C_LINE	40,"wyz_player.h::wyz_play_sound::0::116"

; Function wyz_stop_sound flags 0x00000200 __smallc 
; void wyz_stop_sound()
	C_LINE	40,"wyz_player.h::wyz_stop_sound::0::116"
._wyz_stop_sound
		call PLAYER_OFF
		xor a
		ld  (_isr_player_on), a
	...
	C_LINE	50,"wyz_player.h::wyz_stop_sound::0::117"
	...
	C_LINE	105,"mk1.c::wyz_stop_sound::0::117"
	C_LINE	0,"my/title_screen.h::wyz_stop_sound::0::117"
	C_LINE	6,"my/title_screen.h::wyz_stop_sound::0::117"

; Function title_screen flags 0x00000200 __smallc 
; void title_screen()
	C_LINE	6,"my/title_screen.h::title_screen::0::117"
._title_screen
	call	_blackout
	ld	hl,_s_title
	push	hl
...
.i_181
	...
	C_LINE	108,"mk1.c::title_screen::0::121"
	C_LINE	0,"mainloop.h::title_screen::0::121"
	C_LINE	7,"mainloop.h::title_screen::0::121"

; Function main flags 0x00000000 __stdc 
; void main()
	C_LINE	7,"mainloop.h::main::0::122"
._main
	call	_wyz_init
		di
		ld  hl, 0xC000
...
.i_192
	...
	jp	i_190	;EOS
.i_191
	C_LINE	0,"my/ci/after_load.h::main::1::126"
	C_LINE	176,"mainloop.h::main::1::126"
		ei
.i_193
	ld	hl,0	;const
	ld	a,l
	ld	(_level),a
	call	_title_screen
	C_LINE	0,"my/ci/before_game.h::main::2::127"
	C_LINE	197,"mainloop.h::main::2::127"
	C_LINE	0,"mainloop/game_loop.h::main::3::128"
	...
	ld	hl,1	;const
	call	_wyz_play_music
	C_LINE	0,"./my/ci/entering_game.h::main::3::128"
	C_LINE	51,"mainloop/game_loop.h::main::3::128"
	ld	hl,0	;const
	ld	a,l
	ld	(_half_life),a
	ld	a,l
...
.i_195
	...
	call	l_ne
	jp	nc,i_197	;
	C_LINE	0,"./my/ci/before_entering_screen.h::main::5::130"
	C_LINE	99,"mainloop/game_loop.h::main::5::130"
	call	_draw_scr
	ld	hl,(_n_pant)
	ld	h,0
	ld	a,l
	ld	(_o_pant),a
	C_LINE	0,"./mainloop/hud.h::main::4::130"
.i_197
	ld	de,(_p_objs)
	ld	d,0
	ld	hl,(_objs_old)
...
.i_199
	...
	ld	a,l
	ld	(_keys_old),a
	C_LINE	163,"mainloop/game_loop.h::main::4::133"
.i_200
	ld	hl,_maincounter
	ld	a,(hl)
	inc	(hl)
	...
	call	_player_kill
	pop	bc
	C_LINE	0,"./my/ci/on_player_killed.h::main::6::135"
	C_LINE	182,"mainloop/game_loop.h::main::6::135"
	jp	i_203	;EOS
.i_202
	ld	hl,0	;const
	ld	a,l
...
.i_205
	call	_hotspots_do
	C_LINE	0,"./mainloop/flick_screen.h::main::4::137"
	ld	a,(_gpx)
	and	a
	jp	nz,i_208	;
	ld	hl,(_p_vx)
...
.i_220
.i_219
	C_LINE	281,"mainloop/game_loop.h::main::4::142"
.i_216
	ld	hl,0	;const
	ld	a,h
	or	l
...
.i_222
	...
	ld	a,l
	ld	(_playing),a
	C_LINE	0,"./my/ci/extra_routines.h::main::4::143"
...
.i_196
	...
	C_LINE	237,"mainloop.h::main::3::143"
	ld	hl,(_success)
	ld	a,l
	and	a
	jp	z,i_224	;
...
; --- Start of Scope Defns ---
	...
	GLOBAL	cpc_PutSpTileMap16x24PxM1
	...
	GLOBAL	cpc_PutTrSp16x24TileMap2bPxM1
