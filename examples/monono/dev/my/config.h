...
#define ORTHOSHOOTERS_BASE_CELL 	2 		// 99 means DONT SHOW!
...
#define PLAYER_VY_INICIAL_SALTO		256 	// Initial junp velocity 
#define PLAYER_MAX_VY_SALTANDO		512 	// Max jump velocity 
