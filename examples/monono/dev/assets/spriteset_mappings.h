...
#define SPRITE_01 (_sprites + 0x0060)
#define SPRITE_02 (_sprites + 0x00C0)
#define SPRITE_03 (_sprites + 0x0120)
#define SPRITE_04 (_sprites + 0x0180)
#define SPRITE_05 (_sprites + 0x01E0)
#define SPRITE_06 (_sprites + 0x0240)
#define SPRITE_07 (_sprites + 0x02A0)
#define SPRITE_08 (_sprites + 0x0300)
#define SPRITE_09 (_sprites + 0x0340)
#define SPRITE_0A (_sprites + 0x0380)
#define SPRITE_0B (_sprites + 0x03C0)
#define SPRITE_0C (_sprites + 0x0400)
#define SPRITE_0D (_sprites + 0x0440)
#define SPRITE_0E (_sprites + 0x0480)
#define SPRITE_0F (_sprites + 0x04C0)
