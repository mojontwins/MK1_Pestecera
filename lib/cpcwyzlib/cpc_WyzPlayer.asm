...
.REPRODUCE_SONIDO
                ...
                CP      $FF
                JR      Z,FIN_SONIDO
                ;LD      (PSG_REG_SEC+0),A ; CANAL A FREQ L
                LD      (PSG_REG_SEC+2),A ; CANAL B FREQ L
                ;LD      (PSG_REG_SEC+4),A ; CANAL C FREQ L
                INC     HL
                LD      A,(HL)
                RRCA
                RRCA
                ...
                RRCA
                AND     @00001111 
                ;LD      (PSG_REG_SEC+1),A ; CANAL A FREQ H
                LD      (PSG_REG_SEC+3),A ; CANAL B FREQ H
                ;LD      (PSG_REG_SEC+5),A ; CANAL C FREQ H
                LD      A,(HL)
                AND     @00001111 
                ;LD      (PSG_REG_SEC+8),A ; CANAL A VOL
                LD      (PSG_REG_SEC+9),A ; CANAL B VOL
                ;LD      (PSG_REG_SEC+10),A ; CANAL C VOL
                INC     HL
                LD      A,(HL)
                AND     A
                JR      Z,NO_RUIDO
                LD      (PSG_REG_SEC+6),A
                ;LD      A,@10110000 ; CANAL A
                LD      A,@10101000 ; CANAL B
                ;LD      A,@10011000 ; CANAL C
                JR      SI_RUIDO
.NO_RUIDO
		        LD      A,@10111000 
.SI_RUIDO
